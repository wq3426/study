 ...
 <form class="validate" method="post" action="activity!saveEdit.do" name="theForm" id="theForm">
   <table cellspacing="1" cellpadding="3" width="100%" class="form-table">
     <tr>
       ...
       <td><input type="text" name="activity.name" maxlength="60" value="${activity.name }"  dataType="string" isrequired="true" />       </td>
      </tr>
      <tr>
	...
	<tr>
       ...
       <td  ><input type="text" name="begin_time" maxlength="60" value="<html:dateformat pattern="yyyy-MM-dd" time="${activity.begin_time }"/>"  dataType="date" isrequired="true" class="dateinput"/></td>
      </tr>
      <tr>
       <th><label class="text">终止时间：</label></th>
       <td  ><input type="text" name="end_time" maxlength="60" value="<html:dateformat pattern="yyyy-MM-dd" time="${activity.end_time }"/>"  dataType="date" isrequired="true" class="dateinput"/></td>
      </tr>
	<tr>
