...
function initBuyTimeDis(dateWhere) {
	...
	// ajax配置
	var options = {
		url : ctx + "/shop/admin/memberStatistics!getBuyTimeDis.do" ,
...
function initBuyFre(dateWhere){
	// ajax配置
	var options = {
		url : ctx + "/shop/admin/memberStatistics!getBuyFre.do",
		data : {'start_date' : dateWhere[0], 'end_date' : dateWhere[1]},
		type : "post",
		dataType:"json",
		success:function(data){
...
function initOrderPrice(where,dateWhere){
	// ajax配置
	var options = {
		url : ctx + "/shop/admin/memberStatistics!getOrderPriceDis.do?" + where,
		data : {'start_date' : dateWhere[0], 'end_date' : dateWhere[1]},
		type : "post",
		dataType:"json",
		success:function(data){
