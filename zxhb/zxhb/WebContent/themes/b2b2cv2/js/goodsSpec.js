...
var SpecOper={
	...
	createSpecBody:function(specAr){
		...
		for(i in specAr){ 
			...
			var td="";
			//如果商品编号为空  则值为： 获取当前sn值+“-”+index
			if(sn==""){
				 td ='<td><input type="text" class="ipt" style="width:150px;" onblur="sn_is_exist(this)" name="sns" value="'+nowsn+"-"+index+'" autocomplete="off" propid="'+propid+'" prop="sn"><span style="float:left;color:red;" class="err"></span>';
			}else{
				 td ='<td><input type="text" class="ipt" style="width:150px;" onblur="sn_is_exist(this)" name="sns" value="'+sn+'" autocomplete="off" propid="'+propid+'" prop="sn"><span style="float:left;color:red;" class="err"></span>';
			}
