...
@Results({
	 ...
	 @Result(name="list",type="freemarker", location="/b2b2c/admin/level/store_level_list.html")
})
@Action("storelevel")
public class StoreLevelAction extends WWAction{
	...
	public String addStoreLevel(){
		try {
			storeLevelManager.addStoreLevel(storeLevel);
	...
	public String editStoreLevel(){
		try {
			storeLevelManager.editStoreLevel(storeLevel);
