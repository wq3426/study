...
public class MemberListTag extends  BaseFreeMarkerTag{
	...
	protected Object exec(Map params) throws TemplateModelException {
		...
		Page pageObj = memberManager.MemberList(Integer.parseInt(page), pageSize, ((StoreMember)ThreadContextHolder.getSessionContext().getAttribute(IStoreMemberManager.CURRENT_STORE_MEMBER_KEY)).getStore_id(), map);
