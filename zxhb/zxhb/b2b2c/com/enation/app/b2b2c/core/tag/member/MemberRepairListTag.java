 ...
 */
@Component
public class MemberRepairListTag extends  BaseFreeMarkerTag{
	...
	protected Object exec(Map params) throws TemplateModelException {
		...
		Page pageObj = memberManager.MemberRepairList(Integer.parseInt(page), pageSize, ((StoreMember)ThreadContextHolder.getSessionContext().getAttribute(IStoreMemberManager.CURRENT_STORE_MEMBER_KEY)).getStore_id(), map);
