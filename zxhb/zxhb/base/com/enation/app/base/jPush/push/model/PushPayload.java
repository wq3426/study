package com.enation.app.base.jPush.push.model;
...
import com.enation.app.base.jPush.push.model.notification.PlatformNotification;
...
public class PushPayload implements PushModel {
    ...
    public static class Builder {
        private Platform platform = null;//推送平台设置
        private Audience audience = null;//推送设备指定
        private Notification notification = null;//通知内容体。是被推送到客户端的内容。与 message 一起二者必须有其一，可以二者并存
        private Message message = null;//消息内容体。是被推送到客户端的内容。与 notification 一起二者必须有其一，可以二者并存 
        private Options options = null;//推送参数
        private SMS sms = null;//短信业务功能
