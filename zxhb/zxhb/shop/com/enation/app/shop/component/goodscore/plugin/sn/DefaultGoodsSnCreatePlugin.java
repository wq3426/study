...
public class DefaultGoodsSnCreatePlugin extends AbstractGoodsSnCreator {
	...
	public String createSn(Map goods)  {
		...
		String sn = "G"+String.format("%04d", Integer.parseInt(goods.get("store_id").toString())) + DateUtil.toString( new Date(System.currentTimeMillis()) ,"yyyyMMddhhmmss" )+StringUtil.getRandStr(4);
		return sn;
	}
