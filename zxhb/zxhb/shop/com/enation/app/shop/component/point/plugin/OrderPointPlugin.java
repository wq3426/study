...
//			
	...
	public void everyDay() {
		...
		for(FreezePoint fp:list){
			...
			if( fp.getOrder_status() == OrderStatus./*ORDER_ROG*/ORDER_APPRAISE ||fp.getOrder_status() == OrderStatus.ORDER_COMPLETE ){
...
//		}
		double point =Double.parseDouble(map.get("point")==null?"0":map.get("point")+""); //商品本身的积分
		double goodsprice = Double.parseDouble(map.get("price")==null?"0":map.get("price")+""); //商品价格
