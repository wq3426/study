...
public class MemberFindPasswordAction extends WWAction{
	...
	public String find(){
		...
		emailModel.getData().put("logo", UploadUtil.replacePath("fs:/images/logo_yellow.png"));
		...
		emailModel.setTitle("重置您的登录密码--"+site.getSitename());
		...
		String aa=MailUtil.sendEmailForFindPassword(emailModel);
		if(aa.equals("0")){
			...
			this.showSuccessJson("邮件发送失败,请重新获取！");
		}
		return this.JSON_MESSAGE;
	}
	/**
	...
	public String modify(){
		...
		this.memberManager.login(member.getUsername(), password);
