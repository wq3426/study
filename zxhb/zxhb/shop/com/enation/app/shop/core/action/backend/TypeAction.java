...
@Results({
	...
	@Result(name="join_spec", type="freemarker", location="/shop/admin/type/type_spec.html"),
...
public class TypeAction extends WWAction {
	...
	public String editOther(){
		...
		if(otherType==4){
			brandlist= this.brandManager.goodsBrand();
			return "join_brand";
		}
		if(otherType == 5){
			specList = this.specManager.list();
			return "join_spec";
		}
		return null;
	}
	...
	public String saveSpec() {
		...
		GoodsType prop= this.goodsTypeManager.getById(typeId);
		prop.setSpec_ids(this.choose_specs);
	...
	public Integer[] getChoose_specs() {
		return choose_specs;
	}

	public void setChoose_specs(Integer[] choose_specs) {
		this.choose_specs = choose_specs;
	}
}
