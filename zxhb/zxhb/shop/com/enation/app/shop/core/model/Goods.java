...
public class Goods implements java.io.Serializable {
	...
	private Integer market_enable; //上下架	上架：1	 下架：0
	...
	private Integer store_id;//对应商铺id
	private Double 	commission;	//商品佣金比例
	private Integer hot_goods;//是否是热门商品    是：1；否0；
	...
	public Integer getHot_goods() {
		return hot_goods;
	}

	public void setHot_goods(Integer hot_goods) {
