...
public class OrderReportManager extends BaseSupport implements
	...
	public Integer getPaymentLogId(Integer orderId) {
		String sql = "select payment_id from es_payment_logs where order_id=? and type="+PaymentLogType.receivable.getValue();
		List list= this.daoSupport.queryForList(sql, orderId);
		JSONObject object = JSONObject.fromObject(list.get(0));
		return object.getInt("payment_id");
