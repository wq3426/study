...
public class ReturnedStatisticsManager implements IReturnedStatisticsManager {
	...
	public List<Map> statisticsMonth_Amount(long year,long month){
		...
		String sql =   "select count(0) as t_num,SUM(alltotal_pay) as t_money, case "+ condition_sql +" as month  from es_sellback_list where tradestatus=3 group by case "+condition_sql;
